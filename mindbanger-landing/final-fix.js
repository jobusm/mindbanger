...
// OTP FIX
let otp = fs.readFileSync('emails/otp-template.html', 'utf-8');
otp = otp.replace(/<!DOCTYPE html>.*<\\/style>/s, \<!DOCTYPE html>
<html>
<head>
  <meta charset="UTF-8">
  <style>
...
otp = otp.substring(0, otp.indexOf('</head>')) + htmlBody;
fs.writeFileSync('emails/otp-template.html', otp, 'utf-8');
