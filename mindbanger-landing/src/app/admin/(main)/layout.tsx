    ...
    return (
      <div className="min-h-screen bg-slate-950 text-white flex items-center justify-center p-4">
        <div className="bg-red-500/10 border border-red-500/20 p-8 rounded-2xl max-w-md text-center">
          <h1 className="text-xl text-red-500 font-bold mb-4">Prístup zamietnutý</h1>
          <p className="text-slate-400 mb-6">Na vstup do tejto sekcie potrebuješ administrátorské práva.</p>
          <a href="/" className="px-6 py-2 bg-slate-800 rounded-lg hover:bg-slate-700 transition">Návrat domov</a>
        </div>
      </div>
    );
  }
    ...
    <div className="min-h-screen bg-slate-950 text-white selection:bg-amber-500/30">
      <nav className="border-b border-white/5 bg-slate-900/50 p-4">
        <div className="max-w-6xl mx-auto flex items-center justify-between">
          ...
          <span className="text-sm text-slate-400">Prihlásený ako: {session.user.email}</span>
        </div>
      </nav>
