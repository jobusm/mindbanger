...
export default async function TermsPage() {
  ...
  const { title, lastUpdated, content } = dict.terms;
  ...
  return (
    <div className="min-h-screen bg-slate-950 text-slate-200 py-20 px-6">
      <div className="max-w-3xl mx-auto">
        ...
        <div 
          className="text-slate-300 space-y-4 leading-relaxed [&>h1]:text-2xl [&>h1]:text-white [&>h1]:font-serif [&>h1]:mb-6 [&>h2]:text-xl [&>h2]:text-white [&>h2]:font-serif [&>h2]:mt-8 [&>h2]:mb-4 [&>p]:mb-4"
